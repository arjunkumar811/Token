...
const connection = new Connection("https://solana-devnet.g.alchemy.com/v2/FffcU9C6hYnq9sIaWyD2ByCpIQAI07z_", "confirmed");
...
airdrop("CBXK8LgoSfpqjp9EGqSDeqnqBdoq5dSbMiaSJUCgW1AA", LAMPORTS_PER_SOL).then(signature => {
